...
class BedroomSwitch extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      port: []
  ...
  componentDidMount() {
    ApiCall('https://api.meraki.com/api/v1/devices/Q2HP-WEUW-2PQD/clients', 'GET', null).then(res => {
      this.setState({
        port: res.data
      });
