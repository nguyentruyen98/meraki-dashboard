...
class BigOfficeSwitch extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      port: []
  ...
  componentDidMount() {
    ApiCall('https://api.meraki.com/api/v1/devices/Q2QW-W2W4-MCNR/clients', 'GET', null).then(res => {
      this.setState({
        port: res.data
      });
...
export default BigOfficeSwitch;